...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BatchFlowException.class)
    public ResponseEntity<ApiResponse<Void>> handleBatchFlowException(BatchFlowException ex) {
        log.error("Batch flow operational error: {}", ex.getMessage(), ex);
